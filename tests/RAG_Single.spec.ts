...
// Create RAG for Character Chanking
  await page.getByRole('link', { name: 'RAG RAG Beta' }).click();
...
await page.waitForTimeout(2000);
  ...
  await page.getByRole('textbox', { name: 'Enter query' }).fill('Provide tecnical Skill of Sagar Sharma from resume');
