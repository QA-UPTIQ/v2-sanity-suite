...
test('login flow (email)', async ({ page }) => {
  ...
  // change Rapid to Deep Thinking and verify the change
...
while (!jobBoardFound) {
    try {
        await page.locator("body > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > button:nth-child(3) > svg:nth-child(1)").click();
  ...
  await page.getByRole('button', { name: 'Send' }).click();
   await page.waitForTimeout(270000); 
    ...
    // aritfacts verification
    page.locator('button:has-text("Artifacts")').click();
