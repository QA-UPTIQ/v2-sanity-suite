...
// Navigate to lounchpad
  ...
  await page.getByRole('button', { name: 'Explore Mattr Launchpad' }).click();
  const page1 = await page1Promise;
  await page1.goto('https://mattr-launchpad-dev.uptiq.dev/leaderboard');
  ...
  await expect(page1.locator('h1')).toContainText('Colleges on Mattr Launchpad');
